  ...
  return (
    <div ref={searchRef} className="relative">
      <button
        ...
        className="text-black hover:text-[#8ED204] transition-colors p-2"
            ...
            <div className="p-4">
              <div className="relative">
                <input
                  ...
                  placeholder="Search..."
                  className="w-full px-4 py-2 pr-10 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#8ED204]"
                />
                <button
