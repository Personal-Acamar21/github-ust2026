          ...
          <div>
            <div className="relative h-96 rounded-lg overflow-hidden mb-6">
              ...
              <div className="absolute top-4 left-4">
                <span className="inline-block bg-[#8ED204] text-black px-3 py-1 rounded-full text-sm font-semibold">
                  {event.type}
                </span>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 space-y-4">
              ...
              <div className="flex items-center text-gray-600">
                <Clock className="h-5 w-5 mr-3 text-[#8ED204]" />
          ...
          <div className="space-y-8">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {event.features.map((feature: string, index: number) => (
                    <div key={index} className="flex items-center">
                      <CheckCircle className="h-5 w-5 text-[#8ED204] mr-2" />
                      <span>{feature}</span>
                    </div>
                  ))}
                </div>
            ...
            {event.coaches && (
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  {event.coaches.map((coach: { name: string; role: string; image: string; bio: string }, index: number) => (
            ...
            <div className="bg-black text-white p-6 rounded-lg">
              <div className="flex items-center mb-4">
                <Award className="h-6 w-6 text-[#8ED204] mr-2" />
              ...
              <div className="flex items-center justify-between">
                ...
                <Button
                  ...
                  className="bg-[#8ED204] text-black px-8 py-3 rounded-lg font-semibold hover:bg-[#8ED204]/90"
                >
                  Register Now
                </Button>
              </div>
